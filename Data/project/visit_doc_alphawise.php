...
<div id="container">
	...
	<div class="bit-14">
		<div class="box-element">
				...
				<form novalidate method="post" action="" class="i-validate"> 
					...
					<div class="lists" style="height:40px">
						<ul class="datalist">
							...
							<li><div><a href="visit_doc_alphawise.php?sort=Z%">Z</a></div></li></ul>
			...
			$result=selVisitDocAlphaWise($cid,$alpha);
			...
			<ul class="list">
				...
				<li>
					<div class="l-float edit-click" id="<?php echo $i; ?>"><a  href="visit_doc_update.php?id=<?php echo $result['id'][$i];?>" class="icon16 edit-16" id="<?php echo $i; ?>" type="button"></a></div>
