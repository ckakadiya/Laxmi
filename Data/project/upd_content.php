...
?>
						<div class="lists " style="padding-top:3px; height:40px; font-weight:bold; background-color: #f4f4f4;">
							<ul class="list">
								...
								{
								?>
							<ul class="list" id="<?php echo 'conrow_'.$j; ?>">
								...
								<li class="content" style="padding-left:0px; width: 30px;" id="<?php echo 'delcon_'.$j; ?>"><a href="javascript:void(0);" >Delete</a></li>						
								<li><div class="clearfix"></div></li>
							</ul>
							<ul class="list" id="<?php echo 'hconrow_'.$j;?>" hidden="hidden">
								<input type="hidden" size="2" id="<?php echo 'hcoid_'.$j;?>" name="hcoid" value="<?php echo $meinfo['coid'][$size]; ?>" />
								<li  id="<?php echo 'editcon_'.$j; ?>">
									<input style="width:130px;" id="<?php echo 'hcon_'.$j; ?>" name="h_con" value="<?php echo $meinfo['content_name'][$size]; ?>" />	
								</li>
								...
								<ul class="list" id="contentbox">
									...
									<li colspan="3" align="center" style="width:100%;"><a style="padding-left:60px;" href="javascript:void(0);" class="icon16-button forms-16" id="ncon" name="ncon">Add more Content Information</a></li>
									<li><div class="clearfix"></div></li>
								</ul>
						<div class="clearfix"></div>
						<ul class="list" id="newcodesc">
							</ul>
							<div class="clearfix"></div>
