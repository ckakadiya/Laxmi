			...
			$start=$pager['offset'];
					...
					?>
								...
								<td title='<?php echo $sel_res['name'][$i];?>'>
									<a href="print_patient_detail.php?pid=<?php echo $sel_res['id'][$i];?>"><?php if(isset($sel_res['name'][$i])){echo compressDetail($sel_res['name'][$i],$GLOBALS['pcno']);}else{echo "-----";}?></a></td>
								<td>
                                ...
                                <td>
									...
									<td>
									<a title='<?php echo $sel_res['email'][$i];?>'href="print_patient_detail.php?pid=<?php echo $sel_res['id'][$i];?>"><?php if(isset($sel_res['email'][$i])){echo compressDetail($sel_res['email'][$i],$GLOBALS['ecno']);}else{echo "-----";}?></a></td>
