...
<div id="container">
	...
	<div class="bit-14">
		<div class="box-element">
        	<div class="box-head-light"><span class="typography-16"></span><h3>Show All MR</h3></div>	
				...
				<form novalidate method="post" action="" class="i-validate"> 
					...
					<div class="lists">
						<ul class="datalist" style="height:40px"> 
							<li><div><a href="mr_reg_alphawise.php?sort=%" class="active">All</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=A%">A</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=B%">B</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=C%">C</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=D%">D</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=E%">E</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=F%">F</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=G%">G</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=H%">H</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=I%">I</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=J%">J</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=K%">K</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=L%">L</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=M%">M</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=N%">N</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=O%">O</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=P%">P</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=Q%">Q</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=R%">R</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=S%">S</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=T%">T</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=U%">U</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=V%">V</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=W%">W</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=X%">X</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=Y%">Y</a></div></li>
							<li><div><a href="mr_reg_alphawise.php?sort=Z%">Z</a></div></li>
						</ul>
...
<!-- 							</div> -->
			...
			$start=$pager['offset'];
					...
					?>
                        ...
                        <section class="no-padding">
			<ul class="list">
				<li><input type="hidden"  value="<?php if(isset($result['id'][$i])){ echo $result['id'][$i];}?>" name="txtvid" id="<?php echo 'vdid_'.$i;?>"/></li>
				<LI title='<?php echo $result['doctor_name'][$i]; ?>'>
					<a href='mr_profile.php?id=<?php echo $result['id'][$i];?>'>
					<?php if(isset($result['mr_name'][$i])){echo compressDetail($result['mr_name'][$i],$GLOBALS['pcno']);}else{echo "-----";}?></a></li>
				<li>
                                	<?php if(isset($result['gender'][$i])){echo $result['gender'][$i];}else{echo "-----";}?>
                                </li>
                             	<li>
					<?php if(isset($result['email'][$i])){echo $result['email'][$i];}else{echo "-----";}?>				</li>
				<li>
					<?php if(isset($result['phno'][$i])){echo $result['phno'][$i];}else{echo "-----";}?>				</li>
				<li>
					<?php if(isset($result['company_name'][$i])){echo $result['company_name'][$i];}else{echo "-----";}?>				</li>
				<li style="width:80px;">
					<?php if(isset($result['medicine_name'][$i])){echo $result['medicine_name'][$i];}else{echo "-----";}?>				</li>
				
				<li>
					<div class="l-float edit-click" id="<?php echo $i; ?>"><a  href="mr_update.php?mrid=<?php echo $result['id'][$i];?>" class="icon16 edit-16" id="<?php echo $i; ?>" type="button"></a></div>
					<!--<div class="l-float delete-click" id="<?php echo $i; ?>"><a href="mr_del.php?id=<?php echo $result['id'][$i];?>" class="icon16 cancel-16" type="button" id="<?php echo $i; ?>"></a></div>--->
						<div class="l-float"><a  onclick='return confirmSubmit()' href='mr_reg.php?op=delete&mrid=<?php echo $result['id'][$i]; ?>'>
		...
		?>
     	<section>
		<div class="alert-msg info-msg" align="center">No Mr Exist</div>
		</section>
                <?php
   		}
             }
