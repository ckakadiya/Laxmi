...
<div id="container">
	...
	<div class="bit-14">
		<div class="box-element">
			...
			<div class="box-content no-padding">
			 <section class="no-padding">
					<div class="lists">
						<ul class="datalist">
							<li><div><a href="show_clients_alpha_wise.php?sort=%">All</a></div></li>
						...
						<br>
			<?php
				$qry="select * from clients order by clientid desc";
				$res=mysql_query($qry) or die(mysql_error());
				
				$qry="select * from clients WHERE firstName LIKE '".$arr_patient['sort']."' or middleName LIKE '".$arr_patient['sort']."' or lastName LIKE '".$arr_patient['sort']."'";
		$sel_res=mysql_query($qry);
			...
			{
				echo "<div class='alert-msg info-msg' align='center'><b>There are no Any Clients.</b></div>";
			}
			 ?>
</BODY>
</html>
