	...
	<div class="bit-14">
		<div class="box-element">
			...
			<div class="box-content no-padding">
				<form method="post" action="renewUpcoming.php" class="i-validate" id="Appointment_reg"> 
					<fieldset>
						...
						<?php
						 ...
						 $qry="select * from policy where clientId='$clientId' AND policyName='$policyName'";
						 $res=mysql_query($qry) or die(mysql_error());
						 $row=mysql_fetch_assoc($res);
						 ?>
						 <section>
						...
						<section>
							<input name="submit" id="" class="i-button no-margin" value="Done" type="submit">
								<a href="upcomingRenewal.php"><input class="icon-16 button" type='button' name="updateaccess" value='Back'></a>
						</section>
					</fieldset>
				</form>
			</div>
